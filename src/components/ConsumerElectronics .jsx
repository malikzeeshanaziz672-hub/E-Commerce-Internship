...
const ConsumerElectronics = () => {
  return (
    <div className="sm:bg-[#F7FAFC] pt-7 pb-7">
      <div className="sm:ml-9 sm:mr-9 ml-4 mr-4 flex sm:flex-row flex-col overflow-hidden">
        ...
        <div className="sm:w-2/8">
          <div className="w-90 h-70 max-[640px]:hidden ">
            ...
            <button className="absolute mt-35 ml-5 bg-white rounded-sm font-medium h-9 w-28">
              Source Now
            </button>
        ...
        <div className="min-[640px]:hidden flex flex-col">
          <h1 className=" ml-4 text-lg mb-5">Consumer electronics</h1>
